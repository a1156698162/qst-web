...
<script type="text/javascript">
	...
	function change() {
		...
		verifyCodeImg.src="verifyCodeServlet?time="+new Date();
	}
</script>
</head>
<body>
	<div class="login_content">
		<div class="login_name">
			...
			<form action="loginServlet" method="post" onsubmit="return validate();">
				...
				<div>
					<font style="float: left">验证码：</font><input style="float: left" name="validateCode" id="validateCode" type="text"
						class="yzm_input" /><a style="float: left" href="javascript:change()"><img id="verifyCodeImg" style="width:90px;height: 30px" src="verifyCodeServlet"></a>
				</div>
				<div align="center">
